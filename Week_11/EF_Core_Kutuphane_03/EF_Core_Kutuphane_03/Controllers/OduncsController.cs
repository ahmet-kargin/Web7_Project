...
using EF_Core_Kutuphane_03.Models;

namespace EF_Core_Kutuphane_03.Controllers
{
    public class OduncsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UyeId,KitaplarIsbn,VerilisTarihi,TeslimTarihi,Iptal")] Odunc odunc)
        {
            ...
            ViewData["KitaplarIsbn"] = new SelectList(_context.Kitaplars, "Isbn", "KitaplarISBN", odunc.KitaplarIsbn);
            ViewData["UyeId"] = new SelectList(_context.Uyelers, "Id", "UyeId", odunc.UyeId);
            return View(odunc);
        }
