...
form.addEventListener("submit",e => {
    e.preventDefault();//formun submit olayı sonrasında sayfanın refresh edilmesini durdurur, engeller.
    ...
    // result.innerHTML=`%${score} oranında ofise dönmek istiyorsunuz.`;
    let score2=0;
    let animationScore = setInterval(() => {
